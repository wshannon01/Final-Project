...
For interactive analysis and visualization, a Johns Hopkins East Baltimore Crime Shiny Application is built using R. The googleVis and ggmap libraries are used for plotting the interactive crime maps.
