...
dat.15$timeap <- paste(dat.15$time, dat.15$timeap) # combine time and AM, PM
# remove whitespace
dat.15$mtime <- substr(strptime(dat.15$time, "%I:%M %p"), 11,19) 
dat.15$mtime <- trimws(dat.15$mtime)

time <- hour(hms(dat.15$mtime)) # convert to military time
